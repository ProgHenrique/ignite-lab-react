...
export type IsAvailableLessonQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type IsAvailableLessonQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', slug: string, availableAt?: any | null } | null };
...
export const IsAvailableLessonDocument = gql`
    query IsAvailableLesson($slug: String) {
  lesson(where: {slug: $slug}) {
    slug
    availableAt
  }
...
/**
 * __useIsAvailableLessonQuery__
 *
 * To run a query within a React component, call `useIsAvailableLessonQuery` and pass it any options that fit your needs.
 * When your component renders, `useIsAvailableLessonQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useIsAvailableLessonQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useIsAvailableLessonQuery(baseOptions?: Apollo.QueryHookOptions<IsAvailableLessonQuery, IsAvailableLessonQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<IsAvailableLessonQuery, IsAvailableLessonQueryVariables>(IsAvailableLessonDocument, options);
      }
export function useIsAvailableLessonLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<IsAvailableLessonQuery, IsAvailableLessonQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<IsAvailableLessonQuery, IsAvailableLessonQueryVariables>(IsAvailableLessonDocument, options);
        }
export type IsAvailableLessonQueryHookResult = ReturnType<typeof useIsAvailableLessonQuery>;
export type IsAvailableLessonLazyQueryHookResult = ReturnType<typeof useIsAvailableLessonLazyQuery>;
export type IsAvailableLessonQueryResult = Apollo.QueryResult<IsAvailableLessonQuery, IsAvailableLessonQueryVariables>;